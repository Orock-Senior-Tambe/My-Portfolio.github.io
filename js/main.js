...
window.addEventListener("scroll", () => {
    ...
    sections.forEach(current => {
        ...
        if(scrolls > sectionTop && scrolls <= sectionTop + sectionHeight){
...
ScrollReveal().reveal('.home .info h2, .section-title-01, .section-title-02', { delay: 500, 
    origin: 'left'});
ScrollReveal().reveal('.home .info h3, .home .info p, .about-info .btn, .contact-right p', { delay: 600, origin:
     'right'});
ScrollReveal().reveal('.home .info .btn,', { delay: 700, origin: 'bottom'});
ScrollReveal().reveal('.media-icons i, contact-left li, .contact-left h3', { delay: 500, origin: 'left', 
interval: 200});
ScrollReveal().reveal('.home-img, .about-img', { delay: 500, origin: 'bottom',});
ScrollReveal().reveal('.about .description, .contact-right', { delay: 600, origin: 'right',});
ScrollReveal().reveal('.about .professional-list li', { delay: 500, origin: 'right',
interval: 200});
ScrollReveal().reveal('.skills-description, .services-description, .contact-card, .gallery-swiper, .contact-left', { delay: 700, origin: 'left',
});
